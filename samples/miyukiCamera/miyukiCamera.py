...
class MiyukiCameraConfig(Config):
    """Configuration for training on camera object dataset.
...
def train(model):
    ...
    dataset_train.load_classObjects(args.dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = MiyukiCameraDataset()
    dataset_val.load_classObjects(args.dataset, "val")
    dataset_val.prepare()
